...
;Port A.0 as EN of LCD
;Port A.1 as RS of LCD
;Port A.2 as RW of LCD

;Port B pins for keypad
...
;Port C pins as INSTRUCTION OR DATA to LCD
...
.def key =r23		;key pointer for EEPROM 
.def status =r24 	;preserve sreg here 

;***** Registers used by delay subroutine 
;***** as local variables 

.def fine =r20		;loop delay counters 
.def medium =r21 
.def coarse =r22 
